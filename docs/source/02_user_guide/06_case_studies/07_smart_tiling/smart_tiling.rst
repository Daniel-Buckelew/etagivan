...
3. Select the **VolumeSearch** feature from the **Features** menu in *navigate*.
...
2. **Press the VolumeSearch Button in the Feature List Configuration Window**:
...
4. **Press Confirm to Begin Imaging**:
...
5. **Switch to the Target Imaging Mode**

   - Switch to the microscope that was specified accordign to the ``target_resolution`` (e.g., switch from macroscale to nanoscale).
...
7. **Start Smart Tiling Acquisition**
